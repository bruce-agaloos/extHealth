...
export const basePath = '/documentation';
// sections.js
const sections = [
    { name: 'Getting Started', type: 'header' },
    { name: 'Introduction', path: 'getting-started/introduction', component: Introduction },
    { name: 'Browser Compatibility', path: 'getting-started/browser-compatibility', component: BrowserCompatibility },
