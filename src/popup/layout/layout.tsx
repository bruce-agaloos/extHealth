...
const Layout = () => {
  ...
  const getFadeInClass = () => {
    ...
    if (
      possibleContent.indexOf(previousContent) <
      possibleContent.indexOf(activeContent)
    ) {
      return "fade-in-top";
    } else if (
      possibleContent.indexOf(previousContent) >
    ...
    <div id="grid" className="no-select">
      <header className="board">
        <div className="TitleLogo">
          ...
          <h2 id="popupTitle" className="popupTitle" onClick={handleTitleClick}>
            extHealth{" "}
            <span className="forc" onClick={handleTitleClick}>
              for Chrome
            </span>
          </h2>
          ...
          <div className="icons">
            <img
              ...
              className={`settingsIcon ${
                rotateClockwise ? "rotate-clockwise" : "rotate-counterclockwise"
              }`}
        ...
        {activeSection === "settings" && (
          <div
            className={`setHead ${
              fadeOut ? "fade-out-bottom" : "fade-in-bottom"
            }`}
          >
      ...
      <section id="body">
        <div className="popupContent" style={{ height: `${popupHeight}px` }}>
          {activeSection === "home" && (
            <div className={`interval ${fadeOut ? "fade-out" : "fade-in"}`}>
              <Home />
            </div>
          )}
          {activeSection === "history" && (
            ...
            >
              {healthTipsData.length === 0 ? (
                ...
                >
                  <span>It seems you don't have any health tips for now</span>
                </div>
              ) : (
          ...
          {activeSection === "settings" && (
            ...
            >
              <div className="sidebar-items">
                <div
                  className={`sidebar ${
                    fadeOut ? "fade-out-left" : "fade-in-left"
                  }`}
                  style={{ overflow: "auto" }}
                >
                  <div
                    className={`subTileHeader ${
                      activeContent === "interval" ? "active" : ""
                    }`}
                  ...
                  <div
                    className={`subTileHeader ${
                      activeContent === "fact-mode" ? "active" : ""
                    }`}
                ...
                <div
                  className={`mainContent ${
                    fadeOut ? "fade-out-right" : "fade-in-right"
                  }`}
                >
                  {activeContent === "interval" && (
                    <div className="tileHeader">
                      <div className="tileBorder">Health Tips Reminder</div>
                    </div>
                  )}
                  ...
                  {activeContent === "fact-mode" && (
                    <div className="tileHeader">
                      <div className="tileBorder">Fact Check Mode</div>
                    </div>
                  )}
                  {activeContent === "others" && (
                    <div className="tileHeader">
                      <div className="tileBorder">Others</div>
                    </div>
                  )}
                  {activeContent === "interval" && (
                  ...
                  {activeContent === "danger" && (
                    <div
                      className={`danger ${fadeOut ? "" : "fade-in-bottom"}`}
                    >
                      <Danger />
                    </div>
                  )}
